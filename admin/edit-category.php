                ...
                <div class="card mb-4">
                  ...
                  <form action="edit-category-api.php" method="post" >
                    ...
                    ?>
                        ...
                        <label for="cat_name">CategoryName:</label>
                        <input type="text" class="form-control" id="cat_name" placeholder="Enter CategoryName" name="cat_name" required value="<?php echo $row->cat_name; ?>">
                        </div>     
                <?php        
                    }
                }
